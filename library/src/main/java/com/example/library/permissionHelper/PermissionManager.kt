...
class PermissionsManager {
    ...
    companion object {
        ...
        fun checkPermissions(context: Context?, permissionList:Array<String>?, requestCode: Int = UtilConstants.PERMISSION_REQUEST_CODE, permissionCallback: PermissionsResultInterface?) : Boolean{
